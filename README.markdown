...
Webrat - provides the headless processing of the application from an external perspective (integration test)
FactoryGirl - provides a mocking strategy for your models
RSpec - provides the BDD framework for testing controllers and models (we won't test views in this project because they are covered by cucumber)
...
(in /Users/brez/Projects/Agnus/agnus_bdd_codetest)
.
...
I still haven't implemented the index method on the features controller (app/controllers/features_controller.rb), let's do that now:
